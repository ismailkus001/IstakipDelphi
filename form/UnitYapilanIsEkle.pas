...
QYapilanMasterDurumu.Value:='DEVAM EDÝYOR';
end;
...
begin
  Application.MessageBox('LÜTFFEN TARÝH ALANINI BOÞ BIRAKMAYIN','HATA',MB_OK+MB_ICONERROR);
  abort;
end;
if (QYapilanMasterAciklama.IsNULL) or
(QYapilanMasterAciklama.Value='' )then
begin
  Application.MessageBox('LÜTFFEN Aciklama ALANINI BOÞ BIRAKMAYIN','HATA',MB_OK+MB_ICONERROR);
  abort;
end;

if (QYapilanMasterDurumu.IsNull) or (QYapilanMasterDurumu.Value='') then
begin
  Application.MessageBox('LÜTFFEN Durumu ALANINI BOÞ BIRAKMAYIN','HATA',MB_OK+MB_ICONERROR);
  abort;
end;
